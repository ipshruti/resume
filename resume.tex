...
% CONTACT INFORMATION
%====================
\def\name{Shruti Priya} % Name Here
\def\phone{(+44) 7376094833}
\def\city{London, UK}
\def\email{me@pshruti.com}
\def\LinkedIn{ipshruti} % linkedin.com/in/______
\def\github{ipshruti} % github username
\def\role{Software Test Engineer} % JOB TITLE
